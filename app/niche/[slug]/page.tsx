...
const NICHES: Record<string, Niche> = {
  ...
  'ai-saas': {
    kind: 'founder',
    title: 'AI Startup Builder for SaaS Founders',
  ...
  'fintech': {
    kind: 'founder',
    title: 'AI Startup Builder for Fintech Founders',
  ...
  'b2b-saas': {
    kind: 'founder',
    title: 'AI Startup Builder for B2B SaaS Founders',
  ...
  'marketplace': {
    kind: 'founder',
    title: 'AI Startup Builder for Marketplace Founders',
  ...
  'edtech': {
    kind: 'founder',
    title: 'AI Startup Builder for Edtech Founders',
  ...
  'healthtech': {
    kind: 'founder',
    title: 'AI Startup Builder for Healthtech Founders',
  ...
  'climate': {
    kind: 'founder',
    title: 'AI Startup Builder for Climate Founders',
  ...
  'agency-replacement': {
    kind: 'founder',
    title: 'AI Startup Builder to Replace Agencies',
  ...
  'creator-economy': {
    kind: 'founder',
    title: 'AI Startup Builder for the Creator Economy',
  ...
  'vertical-saas': {
    kind: 'founder',
    title: 'AI Startup Builder for Vertical SaaS',
  ...
  cleaning: {
    title: 'Cleaning Service Websites',
  ...
  trainer: {
    title: 'Personal Trainer Websites',
  ...
  clinic: {
    title: 'Clinic & Medical Practice Websites',
  ...
  tailor: {
    title: 'Tailor & Fashion Designer Websites',
  ...
  cafe: {
    title: 'Cafe & Coffee Shop Websites',
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  if (!niche) return { robots: { index: false, follow: false } }
  return {
    title: niche.title,
    description: niche.sub,
    alternates: { canonical: `/niche/${slug}` },
    openGraph: {
      title: `${niche.title} — IdeaByLunch`,
      description: niche.sub,
      url: `https://ideabylunch.com/niche/${slug}`,
    },
  }
}
